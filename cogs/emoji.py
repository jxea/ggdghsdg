...
class emoji(commands.Cog):
   ...
   @commands.command(help="returns a list of server's emojis", description="emoji")
    ...
    if emoji is None:
     ...
     return  
      ...
      await sendmsg(self, ctx, f"https://twemoji.maxcdn.com/v/latest/72x72/{ordinal:x}.png", None, None, None, None)
       ...
       e = discord.Embed(color=Colors.yellow, description=f"{Emojis.Emojis.warninging} {ctx.author.mention}: emoji not found")
